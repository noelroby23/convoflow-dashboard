...
export const mockAds = USE_MOCK ? [
  ...
  { id: '4', name: 'Video7-Abdus', status: 'active', spend: 780, impressions: 8900, reach: 6800, frequency: 1.31, clicks: 210, leads: 7, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 111, ctr: 2.36, cpm: 87.6, costPerMeeting: null, costPerActive: null },
  { id: '5', name: 'Carousel2-UK', status: 'paused', spend: 450, impressions: 5600, reach: 4500, frequency: 1.24, clicks: 98, leads: 3, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 150, ctr: 1.75, cpm: 80.4, costPerMeeting: null, costPerActive: null },
  { id: '6', name: 'Video2-Noel', status: 'paused', spend: 510, impressions: 6100, reach: 4900, frequency: 1.24, clicks: 112, leads: 4, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 127.5, ctr: 1.84, cpm: 83.6, costPerMeeting: null, costPerActive: null },
  { id: '7', name: 'Image3-Dark', status: 'paused', spend: 380, impressions: 4800, reach: 3900, frequency: 1.23, clicks: 89, leads: 3, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 126.7, ctr: 1.85, cpm: 79.2, costPerMeeting: null, costPerActive: null },
  { id: '8', name: 'Video6-Social', status: 'paused', spend: 420, impressions: 5200, reach: 4100, frequency: 1.27, clicks: 104, leads: 4, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 105, ctr: 2.00, cpm: 80.8, costPerMeeting: null, costPerActive: null },
  { id: '9', name: 'Video4-Abdus', status: 'paused', spend: 340, impressions: 4300, reach: 3500, frequency: 1.23, clicks: 82, leads: 3, meetings: 0, showed: 0, activeOpps: 0, closedWon: 0, cpl: 113.3, ctr: 1.91, cpm: 79.1, costPerMeeting: null, costPerActive: null },
...
export const mockLeads = USE_MOCK ? [
  ...
  { id: '4', name: 'Claire Watson', company: 'Watson Wealth', sourceAd: 'Video5-Abdus', date: '2026-04-07', stage: 'active', status: 'active', callSummary: 'Financial adviser with high lead volume. Current manual qualification process taking 3+ hours per week. Ready to move forward.', qualityScore: 9, meetingDate: '2026-04-11', followUpAttempts: 1, dealValue: 20000 },
  { id: '5', name: 'Tom Bradley', company: 'Bradley Recruitment', sourceAd: 'Video5-Abdus', date: '2026-04-06', stage: 'noshow', status: 'follow_up', callSummary: 'Recruitment agency owner. Interested but said he needed to check with his partner. AI call went well, booked meeting but did not show.', qualityScore: 6, meetingDate: '2026-04-10', followUpAttempts: 3, dealValue: null },
...
export const mockKPIs = USE_MOCK ? {
  ...
  showedUp: { value: 8, target: 12, unit: '', trend: -33.3 },
  activeOpps: { value: 6, target: 8, unit: '', trend: -25 },
  closedWon: { value: 1, target: 2, unit: '', trend: -50 },
  cpl: { value: 98.9, target: 85, unit: 'AED', trend: +16.4, lowerIsBetter: true },
  costPerMeeting: { value: 707.2, target: 600, unit: 'AED', trend: +17.9, lowerIsBetter: true },
  costPerActive: { value: 1532.3, target: 1200, unit: 'AED', trend: +27.7, lowerIsBetter: true },
...
export const mockTrendsData = USE_MOCK ? [
  ...
  { date: 'Apr 7', spend: 750, leads: 8, cpl: 93.8, meetings: 1 },
  { date: 'Apr 8', spend: 890, leads: 10, cpl: 89.0, meetings: 2 },
  { date: 'Apr 9', spend: 820, leads: 9, cpl: 91.1, meetings: 2 },
  { date: 'Apr 10', spend: 940, leads: 11, cpl: 85.5, meetings: 1 },
  { date: 'Apr 11', spend: 870, leads: 8, cpl: 108.8, meetings: 1 },
  { date: 'Apr 12', spend: 980, leads: 10, cpl: 98.0, meetings: 1 },
...
export const mockCallOutcomes = USE_MOCK ? [
  ...
  { name: 'Not Interested', value: 18, color: '#6B7280' },
